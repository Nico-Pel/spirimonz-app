    ...
    namespace GameUtils {
        ...
        public class YCMenuItemManager {
            ...
            static void ImportProdNetworks() {
                YCPackageManager.InstallPackage(YCPackageManager.UpdatePackageType.ProdNetworks);
                GetYCConfigData();
            ...
            static void ImportRatePopup() {
                YCPackageManager.InstallPackage(YCPackageManager.UpdatePackageType.RatePopup);
            }
