...
namespace YsoCorp {
    namespace GameUtils {
        ...
        public sealed class I18nResourcesManager : BaseManager {

            internal Dictionary<string, Dictionary<string, string>> i18ns = new Dictionary<string, Dictionary<string, string>>();
            ...
            internal string GetString(string key, string lang, GameObject debugObject = null) {
            ...
            internal Sprite GetSprite(string lang) {
