...
namespace YsoCorp {
    namespace GameUtils {
        ...
        public sealed class I18nManager : BaseManager {
            
            [SerializeField] internal I18nResourcesManager i18NResourcesManager;
            ...
            internal void AddElement(I18nElement i18n) {
                this._elements.Add(i18n);
            }

            internal void DelElement(I18nElement i18n) {
