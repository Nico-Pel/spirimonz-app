...
================================================================================ VERSION 2.14.0
- Support latest IAP package version
- Minor improvements and bug fixes
- Update MAX

================================================================================ VERSION 2.13.0
- IAP 5+ support
- Removed Amazon package
- Minor improvements and bug fixes
- Update MAX

================================================================================ VERSION 2.12.0
- Update Firebase 13.6.0
- Update Rate Popup package (see its README)
- Minor improvements and bug fixes

================================================================================ VERSION 2.11.1
- Update Voodoo ADN network

================================================================================ VERSION 2.11.0
- Prevent interstitial init if delay < 0
- Added Voodoo ADN network
- Update MAX
...
================================================================================ VERSION 2.10.0
- Added inter delay for the first ad
- Settings window graphic rework
- Added Settings window customization
- Fixed methods accessibility
- Update Tenjin 1.15.14
- Upgrade MAX
- Minor improvements and fixes

================================================================================ VERSION 2.9.1
- Fix InAppManager for Unity Purchasing package 5.0

================================================================================ VERSION 2.9.0
- Update Facebook 18.0.0
- Update MAX

================================================================================ VERSION 2.8.0
- Added new data at level completion
- Fixes :
    - IAP delayed restore purchaseletion
- Improvements :
    - IAP init subscription handling
    - Interstitial availability getter
    - Cleaning
- Update MAX

================================================================================ VERSION 2.7.1
- Fix Max for Android build with Unity 2022 and below
- Minor improvements

================================================================================ VERSION 2.7.0
- Improvements :
    - Setting for ad pausing gameplay
    - Added YcPredicateShow
    - Added Custom Vibration option
- Fixes :
    - YcFlagShow
    - Error handling in ads callbacks
    - Facebook build error
- Update MAX
    - Added Yandex
    - Removed MyTarget
