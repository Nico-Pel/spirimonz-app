Shader "Ciconia Studio/CS_Ghost/HDRP/CS_Advanced Ghost"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[Space(15)][Header(Main Properties________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________)][Space(15)]_BaseColor("Color -->BaseColor Intensity(A)", Color) = (1,1,1,1)
		_BaseColorMap("Base Color", 2D) = "white" {}
		[Space(15)]_Specular("Specular", Float) = 0.2
		_Glossiness("Smoothness", Range( 0 , 1)) = 0.75
		[Space(35)]_BumpMap("Normal Map", 2D) = "bump" {}
		_BumpScale("Scale", Range( 0 , 4)) = 0.3
		[HDR][Space(15)][Header(Fresnel Properties________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________)][Space(15)]_FresnelColor("Color", Color) = (0.6933962,1,0.9814353,1)
		...
		[Space(15)][Header(Details Properties________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________)][Space(15)]_DetailMap("Detail Map", 2D) = "white" {}
		...
		[HDR][Space(15)][Header(Transparency Properties________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________)][Space(15)]_FillColorBackground("Fill Color Background", Color) = (0,0,0,0)
		_DesaturateBackground("Desaturate Background", Range( 0 , 1)) = 0
		[Space(10)]_Opacity("Opacity", Range( 0 , 1)) = 1
		[Space(15)]_FadeTransparency("Fade", Range( 0 , 1)) = 0
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 texCoord1_g14 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float4 lerpResult5_g14 = lerp( _BaseColor , ( ( _BaseColor * tex2D( _BaseColorMap, texCoord1_g14 ) ) * _BaseColor.a ) , _BaseColor.a);
				float4 Albedo716 = lerpResult5_g14;
				
				float2 uv_BumpMap = packedInput.ase_texcoord5.xy * _BumpMap_ST.xy + _BumpMap_ST.zw;
				float3 unpack3_g12 = UnpackNormalScale( tex2D( _BumpMap, uv_BumpMap ), _BumpScale );
				unpack3_g12.z = lerp( 1, unpack3_g12.z, saturate(_BumpScale) );
				float3 NormalmapXYZ148 = unpack3_g12;
				float clampResult2_g11 = clamp( _FresnelTransIntensity , 0.0 , 400.0 );
				float fresnelNdotV5_g11 = dot( normalWS, V );
				float fresnelNode5_g11 = ( _FresnelTransBias + clampResult2_g11 * pow( max( 1.0 - fresnelNdotV5_g11 , 0.0001 ), _FresnelTransPower ) );
				float temp_output_7_0_g11 = saturate( ( 1.0 - fresnelNode5_g11 ) );
				float OpacityFresnelSub743 = temp_output_7_0_g11;
				
				float Specular732 = _Specular;
				float3 temp_cast_1 = (( Specular732 * OpacityFresnelSub743 )).xxx;
				...
				float4 unityObjectToClipPos420 = TransformWorldToHClip(TransformObjectToWorld(packedInput.ase_texcoord7.xyz));
				float4 computeScreenPos421 = ComputeScreenPos( unityObjectToClipPos420 , _ProjectionParams.x );
				float4 unityObjectToClipPos437 = TransformWorldToHClip(TransformObjectToWorld(float3(0,0,0)));
				float4 computeScreenPos438 = ComputeScreenPos( unityObjectToClipPos437 , _ProjectionParams.x );
				float3 ase_worldPos = GetAbsolutePositionWS( positionRWS );
				float4 transform428 = mul(GetObjectToWorldMatrix(),float4( ase_worldPos , 0.0 ));
				transform428.xyz = GetAbsolutePositionWS((transform428).xyz);
				...
				float4 staticSwitch480 = float4( temp_output_271_0 , 0.0 );
				#endif
				float4 fetchOpaqueVal15 = ASEHDSampleSceneColor(( (ase_grabScreenPosNorm).xyzw + (( staticSwitch480 * (-1.0 + (_Refraction - 0.0) * (1.0 - -1.0) / (2.0 - 0.0)) )).rgba ).xy, 0.0, GetInverseCurrentExposureMultiplier());
				...
				float4 lerpResult258 = lerp( float4( desaturateVar278 , 0.0 ) , ( _FillColorBackground * 1000.0 ) , OpacitySlider208);
				float4 GrabSreenRefraction16 = lerpResult258;
				float clampResult751 = clamp( ( _SelfIllumination * 10.0 ) , 0.0 , 100000.0 );
				float clampResult80 = clamp( _FresnelIntensity , 0.0 , 200.0 );
				float fresnelNdotV72 = dot( normalWS, V );
				...
				float4 lerpResult225 = lerp( ( GrabSreenRefraction16 * clampResult751 ) , ( _FresnelColor * 1000.0 ) , FresnelMask197);
				float4 Emission263 = lerpResult225;
				
				float Smoothness733 = _Glossiness;
				
				float Opacity250 = ( (0.5 + (( 1.0 - _FadeTransparency ) - 0.0) * (1.0 - 0.5) / (1.0 - 0.0)) * temp_output_7_0_g11 );
				
				surfaceDescription.BaseColor = Albedo716.rgb;
				surfaceDescription.Normal = ( NormalmapXYZ148 * OpacityFresnelSub743 );
				...
				surfaceDescription.Emission = Emission263.rgb;
				surfaceDescription.Smoothness = ( Smoothness733 * OpacityFresnelSub743 );
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 texCoord1_g14 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float4 lerpResult5_g14 = lerp( _BaseColor , ( ( _BaseColor * tex2D( _BaseColorMap, texCoord1_g14 ) ) * _BaseColor.a ) , _BaseColor.a);
				float4 Albedo716 = lerpResult5_g14;
				...
				float clampResult2_g11 = clamp( _FresnelTransIntensity , 0.0 , 400.0 );
				float fresnelNdotV5_g11 = dot( ase_worldNormal, ase_worldViewDir );
				float fresnelNode5_g11 = ( _FresnelTransBias + clampResult2_g11 * pow( max( 1.0 - fresnelNdotV5_g11 , 0.0001 ), _FresnelTransPower ) );
				float temp_output_7_0_g11 = saturate( ( 1.0 - fresnelNode5_g11 ) );
				float OpacityFresnelSub743 = temp_output_7_0_g11;
				...
				float TexturesScale451 = _TexturesScale;
				float4 unityObjectToClipPos420 = TransformWorldToHClip(TransformObjectToWorld(packedInput.ase_texcoord6.xyz));
				float4 computeScreenPos421 = ComputeScreenPos( unityObjectToClipPos420 , _ProjectionParams.x );
				float4 unityObjectToClipPos437 = TransformWorldToHClip(TransformObjectToWorld(float3(0,0,0)));
				float4 computeScreenPos438 = ComputeScreenPos( unityObjectToClipPos437 , _ProjectionParams.x );
				float4 transform428 = mul(GetObjectToWorldMatrix(),float4( ase_worldPos , 0.0 ));
		...
		Pass
		{
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float clampResult2_g11 = clamp( _FresnelTransIntensity , 0.0 , 400.0 );
				float fresnelNdotV5_g11 = dot( ase_worldNormal, V );
				float fresnelNode5_g11 = ( _FresnelTransBias + clampResult2_g11 * pow( max( 1.0 - fresnelNdotV5_g11 , 0.0001 ), _FresnelTransPower ) );
				float temp_output_7_0_g11 = saturate( ( 1.0 - fresnelNode5_g11 ) );
				float Opacity250 = ( (0.5 + (( 1.0 - _FadeTransparency ) - 0.0) * (1.0 - 0.5) / (1.0 - 0.0)) * temp_output_7_0_g11 );
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 texCoord1_g14 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float4 lerpResult5_g14 = lerp( _BaseColor , ( ( _BaseColor * tex2D( _BaseColorMap, texCoord1_g14 ) ) * _BaseColor.a ) , _BaseColor.a);
				float4 Albedo716 = lerpResult5_g14;
				...
				float TranslationSpeed329 = _TranslationSpeed;
				float2 temp_cast_14 = (TranslationSpeed329).xx;
				float2 uv_DetailMap = packedInput.ase_texcoord7.xy * _DetailMap_ST.xy + _DetailMap_ST.zw;
				float TexturesScale451 = _TexturesScale;
				float4 unityObjectToClipPos420 = TransformWorldToHClip(TransformObjectToWorld(packedInput.ase_texcoord9.xyz));
				float4 computeScreenPos421 = ComputeScreenPos( unityObjectToClipPos420 , _ProjectionParams.x );
				float4 unityObjectToClipPos437 = TransformWorldToHClip(TransformObjectToWorld(float3(0,0,0)));
				float4 computeScreenPos438 = ComputeScreenPos( unityObjectToClipPos437 , _ProjectionParams.x );
				float3 ase_worldPos = GetAbsolutePositionWS( positionRWS );
		...
		Pass
        {
					...
					)
			{
				...
				ase_worldViewDir = normalize(ase_worldViewDir);
				float clampResult2_g11 = clamp( _FresnelTransIntensity , 0.0 , 400.0 );
				float fresnelNdotV5_g11 = dot( packedInput.normalWS, ase_worldViewDir );
				float fresnelNode5_g11 = ( _FresnelTransBias + clampResult2_g11 * pow( max( 1.0 - fresnelNdotV5_g11 , 0.0001 ), _FresnelTransPower ) );
				float temp_output_7_0_g11 = saturate( ( 1.0 - fresnelNode5_g11 ) );
				float Opacity250 = ( (0.5 + (( 1.0 - _FadeTransparency ) - 0.0) * (1.0 - 0.5) / (1.0 - 0.0)) * temp_output_7_0_g11 );
